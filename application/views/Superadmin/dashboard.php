...
<head>
  ...
  <style>
    ...
    .formmapel .box-header {
      border-radius: 1em 1em 0 0;
      padding: 1em;
    }
    .tabel-tambah-mapel > thead > tr > th {
      background-color: #fff;
      color: #000
    }

    .tabel-tambah-mapel .edit_warna{
      width: 80px;
      display: inline-block;
    }

    .tabel-tambah-mapel .btnhapus{
      width: 80px;
      display: inline-block;
...
<li class="treeview">
  ...
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('superadmin/pengaturanpresensisiswa');?>">Pengaturan Presensi Siswa</a></li> 
  </ul> 
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('superadmin/pengaturantambahmapel');?>">Pengaturan Tambah Mapel</a></li> 
  </ul> 
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('superadmin/pengaturanmengelolaharidanjam');?>">Pengaturan Mengelola Hari & Jam</a></li> 
  </ul> 
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('superadmin/pengaturanjadwalpiketguru');?>">Pengaturan Jadwal Piket Guru</a></li> 
  </ul> 
  <ul class="treeview-menu">
    <li><a href="<?php echo site_url('superadmin/pengaturanjenisektrakulikuler');?>">Pengaturan Jenis Ektrakulikuler</a></li> 
  </ul> 
</li>
</ul>
</section>
