        ...
        if (in_array("26", $arrmenuakses)) {
          ...
          <li ><a href="#"><i class="fa fa-circle-o"></i> Penilaian</a>
           <ul class="treeview-menu">
            ...
            <?php 
            if (in_array("30", $arrmenuakses)) { //nilaisiswa
              ?>
            ...
            ?>
             ...
             <?php 
            if (in_array("31", $arrmenuakses)) { //Kompetensi
              ?>
            ...
            <?php 
            if (in_array("32", $arrmenuakses)) { //kategorinilai
              ?>
            ...
            <?php 
            if (in_array("33", $arrmenuakses)) { //jenisNA
              ?>
            ...
            <?php 
            if (in_array("35", $arrmenuakses)) { //rapor
              ?>
        ...
        <li class="treeview"><a href="#"><i class="fa fa-circle-o"></i> Ekstrakurikuler</a>
          <ul class="treeview-menu">
            ...
            if (in_array("42", $arrmenuakses)) {
              ...
              ?>
              <li><a href="<?php echo base_url();?>kurikulum/ekstrakurikuler"><i class="fa fa-circle-o text-red"></i> Jadwal Ekstrakurikuler</a></li>
              <?php
            }{
            ?>
...
<li class="treeview">
  ...
  <?php 
    if (in_array("17", $arrmenuakses)) { ?>
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('kurikulum/pengaturantambahmapel');?>">Pengaturan Tambah Mapel</a></li> 
      </ul> 
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('kurikulum/pengaturanmengelolamapel');?>">Pengaturan Mengelola Mapel</a></li> 
      </ul> 
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('kurikulum/pengaturanharidanjam');?>">Pengaturan Hari & Jam</a></li> 
      </ul> 
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('kurikulum/pengaturanjammengajarguru');?>">Pengaturan Jam Mengajar Guru</a></li> 
      </ul> 
      <ul class="treeview-menu">
        <li><a href="<?php echo site_url('kurikulum/pengaturanjadwalpiketguru');?>">Pengaturan Jadwal Piket Guru</a></li> 
      </ul> 
      <ul class="treeview-menu">
