<div class="content-wrapper">
      ...
      <section class="content">
        <div class="box formmapel">
                    ...
                    foreach ($warna as $w) {
                        ...
                        <tr>
                            ...
                            <td> 
                                ...
                                href="<?php echo site_url('kurikulum/hapuswarnamapelsidebar/'.$w->id); ?>" > Hapus 
                                </a>
                            </td>               
                        </tr>
                    <?php
            ...
            <form id="formmapel" class="form-horizontal" method="post" action="<?php echo site_url('kurikulum/simpanwarnamapelsidebar'); ?>" style="padding: 1em;">
