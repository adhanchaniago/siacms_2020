      ...
      <div class="col-md-12">
        <div class="nav-tabs-custom">
          <ul class="nav nav-tabs">
            ...
            <?php endif ?>
            <li class="<?php echo $this->session->flashdata('position_tab') == 2 ? 'active' : '' ?>"><a href="#dataekstrakurikuler" data-toggle="tab">Data Ekskul </a></li>
          ...
          <div class="tab-content">
            ...
            if($this->session->userdata('jabatan') == 'Ekskul') :
              ...
              <form style="display:block;" class="form-horizontal" method="post" action="<?php echo site_url('ekstrakurikuler/simpanjadwalekskul'); ?>">
        ...
        <!-- /.tab-pane -->
        <div class="tab-pane <?php echo $this->session->flashdata('position_tab') == 2 ? 'active' : '' ?>" id="dataekstrakurikuler" style="padding: 1em;">          
                    ...
                    <tr>
                      ...
                      if($this->session->userdata('jabatan') == 'Ekskul') :
                        ...
                        <td> 
                          ...
                          >Edit</button>
                          <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-danger btn-primary button-action btnhapus" href="<?php echo site_url('ekstrakurikuler/hapusjadwalekskul/'.$row_jadwalekskul->id_jadwal_ekskul); ?>" > Hapus </a>
                        </td>               
                      <?php endif ?>
                    </tr>
                    <?php
        ...
        <div class="tab-pane <?php echo $this->session->flashdata('tab_pos') == 3 ? 'active' : '' ?>" id="data_jenis">
            <div class="box-body">
              <?php
                if($this->session->userdata('jabatan') == 'Ekskul') :
              ?>
                      ...
                      foreach ($tabel_jenisklstambahan as $row_jenisklstambahan) {
                        ...
                        ?>
                          <td> 
                            ...
                            name_eskul="<?php echo $row_jenisklstambahan->jenis_kls_tambahan; ?>"> Edit </button>
                            &nbsp;
                            <a onclick="return confirm('Apakah Anda yakin?')" class="btn btn-block btn-danger button-action btnedit" 
                            href="<?php echo site_url('ekstrakurikuler/hapus_jenis_kls_tambahan/'); ?><?php echo $row_jenisklstambahan->id_jenis_kls_tambahan; ?>"> Hapus </a>
                          </td>               
                        <?php endif ?>
                        </tr>
                        <?php
...
<div id="modal_tambah_eskul" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="post" action="<?php echo site_url('ekstrakurikuler/tambah_jenis_kls_tambahan'); ?>">
...
<div id="modal_edit_eskul" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="post" action="<?php echo site_url('ekstrakurikuler/edit_jenis_kls_tambahan'); ?>">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
...
<div id="modal_edit_jadwal_eskul" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="post" class="form-horizontal" action="<?php echo site_url('ekstrakurikuler/simpanjadwalekskul'); ?>">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
