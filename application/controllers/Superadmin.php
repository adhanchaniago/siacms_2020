...
// tutup home
	...
	public function pengaturanpresensisiswa()
	{
		...
		$this->template->load('superadmin/dashboard','superadmin/pengaturan_presensi_siswa', $data);
	}
	...
	public function pengaturantambahmapel()
	{
		...
		$this->template->load('superadmin/dashboard','superadmin/pengaturan_tambah_mapel', $data);
	}

	public function pengaturanmengelolaharidanjam()
	{
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->load->model('penjadwalan/Mod_pengaturan_hari');
        $data['tabel_pengaturan_hari'] = $this->Mod_pengaturan_hari->get();
		$this->template->load('superadmin/dashboard','superadmin/pengaturan_mengelola_hari_dan_jam', $data);
	}
	...
	public function pengaturanjadwalpiketguru()
	{
		...
		$this->template->load('superadmin/dashboard','superadmin/pengaturan_jadwal_piket_guru', $data);
	}
	...
	public function pengaturan_jadwalpiketgurusidebar()
    {
        ...
        redirect('superadmin/pengaturanjadwalpiketguru');
	}
	
	public function pengaturanjenisektrakulikuler()
	{
		$data['nama'] = $this->session->Nama;
		$data['foto'] = $this->session->foto;
		$this->load->model('penjadwalan/mod_jenisklstambahan');
		$data['tabel_jenisklstambahan'] = $this->mod_jenisklstambahan->get();
		$this->template->load('superadmin/dashboard','superadmin/pengaturan_jenis_ektrakulikuler', $data);
	}
	...
	public function hapus_jenis_kls_tambahan($id = 0)
	{
		...
		redirect('superadmin/pengaturanjenisektrakulikuler');
	}
	...
	public function savepengaturanharisidebar()
    {
        ...
        redirect('superadmin/pengaturanmengelolaharidanjam');
    }
	...
	public function simpanwarnamapelsidebar()
    {
        ...
        redirect('superadmin/pengaturantambahmapel');
	}
	...
	public function pengaturan_presensi()
    {
        ...
        redirect('superadmin/pengaturanpresensisiswa');
    }
